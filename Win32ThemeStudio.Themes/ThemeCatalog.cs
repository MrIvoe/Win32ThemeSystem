...
public static class ThemeCatalog
{
    ...
    public static ReadOnlyCollection<ThemeDescriptor> Themes { get; } =
        ...
        [
            ...
            new ThemeDescriptor(
                "Aurora Light",
                "pack://application:,,,/Win32ThemeStudio.Themes;component/Themes/Palettes/AuroraLight.xaml",
                ThemeAppearance.Light,
                ThemeCategories.Glass,
                ThemeAccentFamilies.Blue,
            ...
            new ThemeDescriptor(
                "Nocturne Dark",
                "pack://application:,,,/Win32ThemeStudio.Themes;component/Themes/Palettes/NocturneDark.xaml",
                ThemeAppearance.Dark,
    ...
    {
        return GetTheme(themeName).ResourceUri;
    }

    public static ThemeDescriptor GetTheme(string themeName)
    {
        if (!ThemeMetadata.TryGetValue(themeName, out var theme))
        {
            throw new ArgumentException($"Theme '{themeName}' does not exist.", nameof(themeName));
        }
